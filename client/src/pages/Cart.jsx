...
const Cart = () => {
     ...
     const {products,currency,cartItems,removeFromCart,getCartItemsCount,updateCartItem,navigate,getCartAmount,axios,user,setCartItems} = useAppContext();
                        ...
                        {showAddress && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                                {address.map((addr, index) => (
                                    <p key={index} onClick={() => {setSelectedAddress(addr); setShowAddress(false)}} className="text-gray-500 hover:bg-gray-100 cursor-pointer p-2">
